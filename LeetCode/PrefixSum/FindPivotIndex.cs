...
{
    // Source: https://leetcode.com/problems/find-pivot-index/solutions/6416124/simple-best-solution-100-beats-by-iqbald-3p49/
    /*
    ...
    public static class FindPivotIndex
    {
        static int PivotIndex(int[] nums)
        {
            ...
            {
                int nRightSum = nTotalSum - nLeftSum - nums[i];
