...
namespace DataStructureAlgorithm.LeetCode.LinkedList
{
     ...
     */
    public static class MaximumTwinSumLinkedList
    {
        ...
        public static void Execute()
        {
            ...
            Console.WriteLine(PairSum(head1)); // Output: 6

            // Test case 2
            ListNode head2 = new ListNode(4, new ListNode(2, new ListNode(2, new ListNode(3))));
            Console.WriteLine(PairSum(head2)); // Output: 7

            // Test case 3
            ListNode head3 = new ListNode(1, new ListNode(100000));
            Console.WriteLine(PairSum(head3)); // Output: 100001
        }
    }
}
